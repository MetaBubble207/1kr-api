...
class AtkXQZ1703563311003 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`tags\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` char(15) NOT NULL COMMENT '名称', UNIQUE INDEX \`uniq_name\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`social_circle_tags\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`tagId\` varchar(36) NULL, \`circleId\` varchar(36) NULL, UNIQUE INDEX \`uniq_circel_tag\` (\`circleId\`, \`tagId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`social_circles\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`free\` tinyint NOT NULL COMMENT '是否免费', \`name\` char(15) NOT NULL COMMENT '名称', \`description\` varchar(255) NOT NULL COMMENT '描述', \`cover\` varchar(255) NOT NULL COMMENT '封面图片', \`bgImage\` varchar(255) NOT NULL COMMENT '背景图片', \`memberCount\` int NOT NULL COMMENT '成员数量', \`followerCount\` int NOT NULL COMMENT '关注者数量', \`userId\` varchar(36) NOT NULL, INDEX \`idx_user\` (\`userId\`), UNIQUE INDEX \`uniq_name\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`social_circle_users\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`expiredTime\` int UNSIGNED NOT NULL COMMENT '到期时间戳' DEFAULT '0', \`userId\` varchar(36) NULL, \`circleId\` varchar(36) NULL, INDEX \`idx_user_createdAt\` (\`userId\`, \`createdAt\`), INDEX \`idx_circel_createdAt\` (\`circleId\`, \`createdAt\`), UNIQUE INDEX \`uniq_circel_user\` (\`circleId\`, \`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`social_circle_fees\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`type\` tinyint UNSIGNED NOT NULL COMMENT '收费类型,1月付,2季度付,3年付,4终身', \`amount\` int UNSIGNED NOT NULL COMMENT '费用', \`circleId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`social_circle_followers\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, \`circleId\` varchar(36) NULL, INDEX \`idx_user_createdAt\` (\`userId\`, \`createdAt\`), INDEX \`idx_circel_createdAt\` (\`circleId\`, \`createdAt\`), UNIQUE INDEX \`uniq_circel_user\` (\`circleId\`, \`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`comments\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL COMMENT '删除时间', \`content\` varchar(255) NOT NULL COMMENT '内容' DEFAULT '', \`likeCount\` int NOT NULL COMMENT '点赞数' DEFAULT '0', \`replyCount\` int NOT NULL COMMENT '回复数量，只有根节点存储该值' DEFAULT '0', \`upvoteCount\` int NOT NULL COMMENT '赞成票数' DEFAULT '0', \`downvoteCount\` int NOT NULL COMMENT '反对票数' DEFAULT '0', \`best\` tinyint NOT NULL COMMENT '是否是最佳答案' DEFAULT 0, \`mpath\` varchar(255) NULL DEFAULT '', \`postId\` varchar(36) NOT NULL, \`userId\` varchar(36) NOT NULL, \`parentId\` int NULL, INDEX \`IDX_e44ddaaa6d058cb4092f83ad61\` (\`postId\`), INDEX \`IDX_7e8d7c49f218ebb14314fdb374\` (\`userId\`), INDEX \`idx_user\` (\`userId\`, \`createdAt\`), INDEX \`idx_post\` (\`postId\`, \`createdAt\`), INDEX \`idx_mpath\` (\`mpath\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`social_circle_post_likes\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, \`postId\` varchar(36) NULL, INDEX \`idx_post\` (\`postId\`, \`createdAt\`), UNIQUE INDEX \`uniq_user_post\` (\`userId\`, \`postId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`social_circle_courses\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL COMMENT '删除时间', \`title\` varchar(255) NOT NULL COMMENT '标题' DEFAULT '', \`description\` varchar(10000) NOT NULL COMMENT '介绍' DEFAULT '', \`cover\` varchar(255) NOT NULL COMMENT '封面图', \`qa\` tinyint NOT NULL COMMENT '问答模块是否开启' DEFAULT 0, \`online\` tinyint NOT NULL COMMENT '是否上线' DEFAULT 0, \`circleId\` varchar(36) NOT NULL, INDEX \`idx_circle_createdAt\` (\`circleId\`, \`createdAt\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`social_circle_sections\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL COMMENT '删除时间', \`title\` varchar(255) NOT NULL COMMENT '标题' DEFAULT '', \`content\` text NOT NULL COMMENT '内容' DEFAULT '', \`free\` tinyint NOT NULL COMMENT '是否可试看' DEFAULT 0, \`duration\` int UNSIGNED NOT NULL COMMENT '时长' DEFAULT '0', \`online\` tinyint NOT NULL COMMENT '是否上线' DEFAULT 0, \`sequence\` int NOT NULL COMMENT '索引' DEFAULT '1', \`chapterId\` varchar(36) NOT NULL, INDEX \`idx_chapter_createdAt\` (\`chapterId\`, \`createdAt\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`social_circle_chapters\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL COMMENT '删除时间', \`title\` varchar(255) NOT NULL COMMENT '标题' DEFAULT '', \`sequence\` int NOT NULL COMMENT '索引' DEFAULT '1', \`online\` tinyint NOT NULL COMMENT '是否上线' DEFAULT 0, \`courseId\` varchar(36) NOT NULL, INDEX \`idx_course_createdAt\` (\`courseId\`, \`createdAt\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`social_circle_posts\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL COMMENT '删除时间', \`business\` enum ('feed', 'forum', 'course') NOT NULL COMMENT '业务', \`sectionId\` varchar(255) NOT NULL DEFAULT '', \`title\` varchar(255) NOT NULL COMMENT '标题' DEFAULT '', \`content\` text NOT NULL COMMENT '内容' DEFAULT '', \`commentCount\` int NOT NULL COMMENT '评论数' DEFAULT '0', \`likeCount\` int NOT NULL COMMENT '点赞数' DEFAULT '0', \`repostCount\` int NOT NULL COMMENT '转发数' DEFAULT '0', \`collectCount\` int NOT NULL COMMENT '收藏数' DEFAULT '0', \`disableComment\` tinyint NOT NULL COMMENT '是否禁止新评论' DEFAULT 0, \`userId\` varchar(36) NOT NULL, \`circleId\` varchar(36) NOT NULL, INDEX \`idx_circle_likeCount\` (\`circleId\`, \`likeCount\`), INDEX \`idx_circle_commentCount\` (\`circleId\`, \`commentCount\`), INDEX \`idx_circle_section_createdAt\` (\`circleId\`, \`sectionId\`, \`createdAt\`), INDEX \`idx_circle_createdAt\` (\`circleId\`, \`createdAt\`), INDEX \`idx_user\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`collects\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL COMMENT '删除时间', \`title\` varchar(255) NOT NULL COMMENT '收藏夹名称', \`userId\` varchar(36) NOT NULL, INDEX \`idx_user\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`collect_posts\` (\`id\` int NOT NULL AUTO_INCREMENT, \`remark\` varchar(255) NOT NULL COMMENT '备注' DEFAULT '', \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`collectId\` varchar(36) NULL, \`postId\` varchar(36) NULL, INDEX \`idx_collect\` (\`collectId\`, \`createdAt\`), UNIQUE INDEX \`uniq_collect_post\` (\`collectId\`, \`postId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`social_circle_tags\` ADD CONSTRAINT \`FK_33567f5c25b5374be1d879e350a\` FOREIGN KEY (\`tagId\`) REFERENCES \`tags\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`social_circle_tags\` ADD CONSTRAINT \`FK_4e6272e984c1987329d2d08b604\` FOREIGN KEY (\`circleId\`) REFERENCES \`social_circles\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`social_circles\` ADD CONSTRAINT \`FK_193c83ce6d4caa380cebdba8042\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`social_circle_users\` ADD CONSTRAINT \`FK_aad9509ac5cf2026fa7aa11b3d7\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`social_circle_users\` ADD CONSTRAINT \`FK_2d91f37f4b36b8b3fd9dd99f787\` FOREIGN KEY (\`circleId\`) REFERENCES \`social_circles\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`social_circle_fees\` ADD CONSTRAINT \`FK_6205661867e19294cfcb83417d2\` FOREIGN KEY (\`circleId\`) REFERENCES \`social_circles\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`social_circle_followers\` ADD CONSTRAINT \`FK_91ad19a82446d6970edca26735d\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`social_circle_followers\` ADD CONSTRAINT \`FK_d61891025f1e30d09c8ada36fd4\` FOREIGN KEY (\`circleId\`) REFERENCES \`social_circles\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`social_circle_post_likes\` ADD CONSTRAINT \`FK_7ad3480eff73fad2e4a9e652085\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`social_circle_post_likes\` ADD CONSTRAINT \`FK_b1a8576b8b4aac096a782a3ed8f\` FOREIGN KEY (\`postId\`) REFERENCES \`social_circle_posts\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`social_circle_posts\` ADD CONSTRAINT \`FK_ef9b9fe982802ea5a6407af59d9\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`social_circle_posts\` ADD CONSTRAINT \`FK_5344660f04a1d8a44b52dbd5bd8\` FOREIGN KEY (\`circleId\`) REFERENCES \`social_circles\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE \`collects\` ADD CONSTRAINT \`FK_1b3d95e3f902fc5f570e9707282\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`collect_posts\` ADD CONSTRAINT \`FK_4411804767a2b281de3ea78964e\` FOREIGN KEY (\`collectId\`) REFERENCES \`collects\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`collect_posts\` ADD CONSTRAINT \`FK_6a5fd455e5473286061747998de\` FOREIGN KEY (\`postId\`) REFERENCES \`social_circle_posts\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`collect_posts\` DROP FOREIGN KEY \`FK_6a5fd455e5473286061747998de\``);
        await queryRunner.query(`ALTER TABLE \`collect_posts\` DROP FOREIGN KEY \`FK_4411804767a2b281de3ea78964e\``);
        ...
        await queryRunner.query(`ALTER TABLE \`social_circle_posts\` DROP FOREIGN KEY \`FK_5344660f04a1d8a44b52dbd5bd8\``);
        await queryRunner.query(`ALTER TABLE \`social_circle_posts\` DROP FOREIGN KEY \`FK_ef9b9fe982802ea5a6407af59d9\``);
        ...
        await queryRunner.query(`ALTER TABLE \`social_circle_post_likes\` DROP FOREIGN KEY \`FK_b1a8576b8b4aac096a782a3ed8f\``);
        await queryRunner.query(`ALTER TABLE \`social_circle_post_likes\` DROP FOREIGN KEY \`FK_7ad3480eff73fad2e4a9e652085\``);
        ...
        await queryRunner.query(`ALTER TABLE \`social_circle_followers\` DROP FOREIGN KEY \`FK_d61891025f1e30d09c8ada36fd4\``);
        await queryRunner.query(`ALTER TABLE \`social_circle_followers\` DROP FOREIGN KEY \`FK_91ad19a82446d6970edca26735d\``);
        await queryRunner.query(`ALTER TABLE \`social_circle_fees\` DROP FOREIGN KEY \`FK_6205661867e19294cfcb83417d2\``);
        await queryRunner.query(`ALTER TABLE \`social_circle_users\` DROP FOREIGN KEY \`FK_2d91f37f4b36b8b3fd9dd99f787\``);
        await queryRunner.query(`ALTER TABLE \`social_circle_users\` DROP FOREIGN KEY \`FK_aad9509ac5cf2026fa7aa11b3d7\``);
        await queryRunner.query(`ALTER TABLE \`social_circles\` DROP FOREIGN KEY \`FK_193c83ce6d4caa380cebdba8042\``);
        await queryRunner.query(`ALTER TABLE \`social_circle_tags\` DROP FOREIGN KEY \`FK_4e6272e984c1987329d2d08b604\``);
        await queryRunner.query(`ALTER TABLE \`social_circle_tags\` DROP FOREIGN KEY \`FK_33567f5c25b5374be1d879e350a\``);
        ...
        await queryRunner.query(`DROP INDEX \`idx_circle_commentCount\` ON \`social_circle_posts\``);
        ...
        await queryRunner.query(`DROP INDEX \`idx_circel_createdAt\` ON \`social_circle_followers\``);
